...
当前发布版本是 **v1.14.0-beta.1**，架构代际定位为 **Codex Harness Kernel v4.7.0**。它只负责交付经过验证的代码和证据，不负责生产部署、上线发布、基础设施开通、生产迁移、密钥变更或付费资源创建。
...
当前 README 描述的是 v1.14 beta / Kernel v4.7 插件格式：
