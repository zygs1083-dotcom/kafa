...
from core.schema_lifecycle import create_schema, ensure_column
...
def validate_delivery(conn: sqlite3.Connection, root: Path, *, require_phase: bool = False) -> list[str]:
    from core.gate_engine import DeliveryDecisionServices, evaluate_delivery_readiness

    return evaluate_delivery_readiness(
        conn,
        root,
        DeliveryDecisionServices(
