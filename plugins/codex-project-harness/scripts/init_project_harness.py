...
FILES = {
    ...
    ".ai-team/requirements/failure-modes.md": "# Failure Modes\n\n| ID | Feature | Scenario | Trigger | Expected Behavior | Recovery | Data Safety | Risk | Test Mapping | Status | Accepted By | Acceptance Reason | Acceptance Scope | Accepted Revision | Expires At |\n| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |\n",
    ...
    "docs/harness/validation.md": "# Validation\n\n| Surface | Acceptance | Failure Modes | Tool Context | Commands | Findings | Pass/Fail | Residual Risk |\n| --- | --- | --- | --- | --- | --- | --- | --- |\n",
