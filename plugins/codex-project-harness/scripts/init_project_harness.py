...
FILES = {
    ...
    ".ai-team/requirements/requirements.md": "# Requirements\n\n| ID | Kind | Body | Priority | Status | Tool Link | Revision |\n| --- | --- | --- | --- | --- | --- | --- |\n",
    ".ai-team/requirements/acceptance.md": "# Acceptance Criteria\n\n| ID | Criterion | Priority | Tool Link | Status |\n| --- | --- | --- | --- | --- |\n",
    ".ai-team/requirements/failure-modes.md": "# Failure Modes\n\n| ID | Feature | Scenario | Trigger | Expected Behavior | Recovery | Data Safety | Risk | Test Mapping | Status | Derived Coverage | Accepted By | Acceptance Reason | Acceptance Scope | Accepted Revision | Expires At |\n| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |\n",
    ...
    "docs/harness/runtime.md": "# Runtime\n\n## Commands\n\n```bash\npython3 plugins/codex-project-harness/scripts/harness.py --root . status\npython3 plugins/codex-project-harness/scripts/harness.py --root . phase planning --status active\npython3 plugins/codex-project-harness/scripts/harness.py --root . requirement add --id R1 --kind functional --body \"Example requirement\"\npython3 plugins/codex-project-harness/scripts/harness.py --root . acceptance add --id AC1 --criterion \"Example acceptance\"\npython3 plugins/codex-project-harness/scripts/harness.py --root . failure-mode add --id FM1 --feature \"Example\" --scenario \"Failure scenario\" --trigger \"Trigger\" --expected \"Expected behavior\"\npython3 plugins/codex-project-harness/scripts/harness.py --root . task add --id T1 --task \"Example task\" --acceptance AC1 --failure-mode FM1\npython3 plugins/codex-project-harness/scripts/harness.py --root . validate --delivery\n```\n\n## State\n\nSQLite is the canonical runtime state at `.ai-team/state/harness.db`. Markdown files under `.ai-team/` and `docs/harness/` are rendered views.\n\n",
    "docs/harness/design-context.md": "# Design Context\n\n| Source | Link / ID | Relevant Screens | Acceptance Notes |\n| --- | --- | --- | --- |\n",
    "docs/harness/validation.md": "# Validation\n\n| Surface | Acceptance | Failure Modes | Head | Source Hash | Diff Hash | Project Revision | Tool Context | Commands | Findings | Pass/Fail | Residual Risk |\n| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |\n",
    "docs/harness/evidence.md": "# Evidence\n\n## Evidence Records\n\n| ID | Kind | Summary | URI | Hash | Created At |\n| --- | --- | --- | --- | --- | --- |\n\n## Test Records\n\n| ID | Surface | Command | Result | Evidence | Created At |\n| --- | --- | --- | --- | --- | --- |\n",
    "docs/harness/findings.md": "# Findings\n\n| ID | Surface | Severity | Status | Summary | Evidence | Created At |\n| --- | --- | --- | --- | --- | --- | --- |\n",
    "docs/harness/quality-gates.md": "# Quality Gates\n\n| Gate | Commit | Base | Head | Source Hash | Diff Hash | Project Revision | Reviewer Context | Result | Blocking Findings | Commands | Evidence | Residual Risk |\n| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |\n",
